...
<%
	...
	try
	{
		 ...
		 */
		//Request 수신.
//		System.out.println( "[ACCIDENT CLOSED] Request received!" );
		 	...
		 	*/
		 	{
				...
				strQuery	= strQuery + "" + TrOasisConstants.TYPE_1_ACCIDENT + "";
				strQuery	= strQuery + "," + TrOasisConstants.TYPE_2_ACCIDENT_CLOSED + "";
				strQuery	= strQuery + ", 0";
...
<%
	...
	catch( Exception e )
	{
		...
		System.out.println( "[ACCIDENT CLOSED]" + status_msg );
%>
<?xml version="1.0" encoding="UTF-8"?>
<troasis>
