...
<%
	...
	try
	{
		 ...
		 */
		//Request 수신.
//		System.out.println( "[DELAY END] Request received!" );
		 	...
		 	*/
		 	{
				...
				strQuery	= strQuery + "," + TrOasisConstants.TYPE_2_DELAY_END + "";
				strQuery	= strQuery + ", 0";
...
<%
	...
	catch( Exception e )
	{
		...
		System.out.println( "[DELAY END]" + status_msg );
%>
<?xml version="1.0" encoding="UTF-8"?>
<troasis>
