...

	{
		...
		List<String>	list_deleted_cctv_id	= new ArrayList<String>();	
			...
			{	
				...
				System.out.println( "delete count  :" + index_d);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			for (int k=1; k<=index_d; k++)
			{
				
				strQuery = "SELECT changed_number";
				strQuery = strQuery + " FROM " + strTableCCTVModificationLog;
...
<%
	for ( int j = 1; j <= index_d; j++ )
	{
%>

		<cctv_changed>
			 <cctv_id><%=list_deleted_cctv_id.get(j)%></cctv_id>      
             <changed_number><%=list_deleted_number.get(j)%></changed_number>
             <changed_type><%=deleted_type%></changed_type>                                                
		</cctv_changed>
<%
	}
%>
