...
<%
	...
	try
	{
		 ...
		 */
		//Request 수신.
//		System.out.println( "[ACCIDENT FOUND] Request received!" );
		 	...
		 	*/
		 	{
				...
				strQuery	= strQuery + "," + TrOasisConstants.TYPE_2_ACCIDENT_FOUND + "";
				strQuery	= strQuery + ", 0";
...
<%
	...
	catch( Exception e )
	{
		...
		System.out.println( "[ACCIDENT FOUND]" + status_msg );
%>
<?xml version="1.0" encoding="UTF-8"?>
<troasis>
