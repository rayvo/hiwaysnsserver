...
<%
	...
	try
	{
		 ...
		 */
		//Request 수신.
//		System.out.println( "[DELAY START] Request received!" );
		 	...
		 	*/
		 	{
				...
				strQuery	= strQuery + "" + TrOasisConstants.TYPE_1_DELAY + "";
				strQuery	= strQuery + "," + TrOasisConstants.TYPE_2_DELAY_START + "";
				strQuery	= strQuery + ", 0";
...
<%
	...
	catch( Exception e )
	{
		...
		System.out.println( "[DELAY START]" + status_msg );
%>
<?xml version="1.0" encoding="UTF-8"?>
<troasis>
