...
<%
	...
	try
	{
		...
		//Request 메시지 파싱.
		out.println( "xml=" + strInputXml );
		inputList	= xmlGen.parseInputXML( strInputXml, inputList );
		for ( int i = 0; i < inputList.length; i++ ) out.println( inputList[i][0] + " = " + inputList[i][1] );
		...
		else
		{
			...
			if ( nCountUsers > 0 )
			{
				...
				strQuery	= strQuery + ", destination = " + inputList[INDEX_DESTINATION][1] + "";
				strQuery	= strQuery + ", purpose = " + inputList[INDEX_PURPOSE][1] + "";
				strQuery	= strQuery + ", link_id = 0";
				strQuery	= strQuery + ", direction = " + TrOasisConstants.DIRECT_NONE;
				strQuery	= strQuery + ", distance = 0";
				strQuery	= strQuery + ", time_log_start = " + inputList[INDEX_TIMESTAMP][1] + "";
				strQuery	= strQuery + ", start_loc_lat = " + inputList[INDEX_POS_LAT][1] + "";
				strQuery	= strQuery + ", start_loc_lng = " + inputList[INDEX_POS_LNG][1] + "";
				strQuery	= strQuery + ", time_log_last = " + inputList[INDEX_TIMESTAMP][1] + "";
				strQuery	= strQuery + ", loc_lat = " + inputList[INDEX_POS_LAT][1] + "";
				strQuery	= strQuery + ", loc_lng = " + inputList[INDEX_POS_LNG][1] + "";
			...
			else
			{
				...
				strQuery	= strQuery + ", " + inputList[INDEX_DESTINATION][1] + "";
				strQuery	= strQuery + ", " + inputList[INDEX_PURPOSE][1] + "";
				strQuery	= strQuery + ", 0";
				strQuery	= strQuery + ", 0";
				strQuery	= strQuery + ", 0";
				strQuery	= strQuery + ", " + inputList[INDEX_TIMESTAMP][1] + "";
				strQuery	= strQuery + ", " + inputList[INDEX_POS_LAT][1] + "";
				strQuery	= strQuery + ", " + inputList[INDEX_POS_LNG][1] + "";
				strQuery	= strQuery + ", " + inputList[INDEX_TIMESTAMP][1] + "";
				strQuery	= strQuery + ", " + inputList[INDEX_POS_LAT][1] + "";
				strQuery	= strQuery + ", " + inputList[INDEX_POS_LNG][1] + "";
				strQuery	= strQuery + ", 0";
