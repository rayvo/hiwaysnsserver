...
<%
	...
	try
	{
		 ...
		 */
		//Request 수신.
//		System.out.println( "[CONSTRUCTION FOUND] Request received!" );
		 	...
		 	*/
		 	{
				...
				strQuery	= strQuery + "" + TrOasisConstants.TYPE_1_CONSTRUCTION + "";
				strQuery	= strQuery + "," + TrOasisConstants.TYPE_2_CONSTRUCTION_FOUND + "";
				strQuery	= strQuery + ", 0";
...
<%
	...
	catch( Exception e )
	{
		...
		System.out.println( "[CONSTRUCTION FOUND]" + status_msg );
%>
<?xml version="1.0" encoding="UTF-8"?>
<troasis>
