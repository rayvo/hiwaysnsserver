				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					...
					<tr>
						<td colspan="10" height="40" align="left" bgcolor="#dbdbdb">
							기준 시각: &nbsp;&nbsp;&nbsp; <%=n_year_sel%>년 <%=n_month_sel%>월 <%=n_date_sel%>일
						</td>
					</tr>
					...
					<tr>
						<td colspan="10" height="40" align="center" bgcolor="#dbdbdb">
							<font style="font-size:11pt; color:#ff5900; line-height:22px">시간대별  이용현황</font>
						</td>
					</tr>
...
<%
	...
	calDate.set(n_year_sel, n_month_sel - 1, n_date_sel, 23, 0, 0);
	...
	for ( i = 0; i < nSizeStatistics; i++ )
	{
		...
		SimpleDateFormat formatter = new SimpleDateFormat( "yyyy년 MM월 dd일 HH시 대역", Locale.KOREA );
...
%>
					...
					<tr>
						<td colspan="10" height="40" align="right">
							<input type="button" id="excel" name="excel" value="Excel 파일로 내려받기" onclick="js_export_data('statistics_hourly_excel.jsp');" onkeypress="js_export_data('statistics_hourly_excel.jsp');">
						</td>
					</tr>
