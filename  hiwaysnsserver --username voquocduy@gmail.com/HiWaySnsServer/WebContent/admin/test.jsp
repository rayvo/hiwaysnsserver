...
<body onload="mapview()">
	<form name="form_main" action="test.jsp" method="post" onsubmit="return js_user_input();">
			<td colspan="4" align="top">
				<strong>검색방법:</strong>&nbsp;
				<select id="search_type" name="search_type" style="width: 160px; color:#000000; background-color:#ffffff;">
					<option value="0" <% if ( search_type < 1) { %>selected<% } %>>전체(User ID+닉네임)
...
onFocus="this.value=''" tabindex="2" /></label>
		    ...
		    <input type="button" value=" 사용하시기 전에 " onclick="pushbutton()"> 
