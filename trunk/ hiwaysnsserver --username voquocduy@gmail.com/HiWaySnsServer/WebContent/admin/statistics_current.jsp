...
<%
	...
	int		n_month_today	= ctoday.get(Calendar.MONTH) + 1;
	int		n_date_today	= ctoday.get(Calendar.DATE);
	int		n_hour_today	= ctoday.get(Calendar.HOUR_OF_DAY);
	int		n_min_today		= ctoday.get(Calendar.MINUTE);
	int		n_sec_today		= ctoday.get(Calendar.SECOND);
%>
			<td width="860" valign="top" align="center">
				<!-- 
				<form name="rtcForm">
					<input type="hidden" name="rtcInput" size="20" readonly="readonly" />
				</form>
				 -->
				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					...
					<tr>
						<td colspan="10" height="40" align="left" bgcolor="#dbdbdb">
							현재 시각: &nbsp;&nbsp;&nbsp; <%=n_year_today%>년 <%=n_month_today%>월 <%=n_date_today%>일 &nbsp;&nbsp;&nbsp; <%=n_hour_today%>시 <%=n_min_today%>분 <%=n_sec_today%>초 &nbsp;&nbsp;(서비스 이용현황은 5초 주기로 자동 갱신됩니다).
						</td>
					</tr>
